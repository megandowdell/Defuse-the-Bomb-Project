...
def show_menu(screen):
    ...
    menu_font = pygame.font.Font("font2.otf", 42)
    
#    title_font = pygame.font.SysFont("agencyfb", 80)
#    menu_font = pygame.font.SysFont("hpsimplifiedbdit", 42)
   
   
    bg_image = pygame.image.load("menu.jpg")
    bg_image = pygame.transform.scale(bg_image, (WIDTH, HEIGHT))
    
    menu_items = ["Start", "How to Play", "Quit"]
    selected_index = 0
    ...
    while True:
        ...
        title_text = title_font.render("Squid Games", True, BEIGE)
        subtitle_text = menu_font.render("Remastered", True, YELLOW)
            ...
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_UP:
                    ...
                    if menu_items[selected_index] == "Start":
                        return "Start"
                    elif menu_items[selected_index] == "How to Play":
                        return "How to Play"
...
def show_how_to_play_screen(screen):
    ...
    # Fonts
    title_font = pygame.font.SysFont("hpsimplifiedbdit", 30)
    button_font = pygame.font.SysFont("hpsimplifiedbdit", 20)
    text_font = pygame.font.SysFont("hpsimplifiedbdit", 15)
    ...
    welcome_text = [
        "As Squad Leader of the Survey Corps Special Operations Unit, you are going to embark on an expedition Beyond The Walls, in an attempt to stop Eren Yaeger from starting The Rumbling - an apocalyptic event that threatens the fate of humanity. Your goal is to get on board The Flying Ship which will take you to Marley to stop their efforts to invade Paradis Island, thereby stopping Eren's plans.",
        "",
        "Before this can happen, you must make it past the concentric walls protecting civilization - Wall Sina, Wall Rose, and Wall Maria - then Beyond The Walls where The Flying Ship is docked. Prepare yourself for a perilous journey as Titans are eagerly anticipating your arrival. You will be given weapons to attack these Titans or you can retreat in the best interest of your team.",
        "",
        "To survive this game, you will need your combat skills, Titan knowledge, and most importantly good judgment. Tread lightly but hastily. The clock is ticking and Eren is becoming impatient. Will you make it to The Flying Ship in time or will you meet an early death and disappoint your squad? Every decision made will dictate the future of Paradis.",
    ]
    ...
    while True:
        ...
        # Draw title
        title_text = title_font.render("How to Play", True, BEIGE)
...
def main():
    ...
    while game_running:
        if game_state == "menu":
            ...
            htp_choice = show_how_to_play_screen(screen)
            if htp_choice == "Menu":
                game_state = "menu"
            elif htp_choice == "Start":
                game_state = "character_select"
